...
ORDERER_CA=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/qrneo-network.com/orderers/orderer.qrneo-network.com/msp/tlscacerts/tls/ca.qrneo-network.com-cert.pem
